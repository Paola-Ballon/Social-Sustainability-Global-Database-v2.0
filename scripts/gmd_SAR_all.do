...
Issues:
	...
	- For some years in AFG, PAK, and LKA we don't have information on contract, internet, healthins, socialsec, tv, radio, washmach, sewmach, mcycle, fridge, car, and ownland
	- For some years in AFG we don't have information on imp_wat_rec, and imp_san_rec
*/
...
* directory macros
global raw_data "${ssgd_v2_userpath}\SSGD v2.0\raw_data\gmd\sar"
