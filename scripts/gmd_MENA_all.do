...
Issues:
	...
	- For MLT all observations belongs to the urban tier
	- For LBN in year 2011 we don't have information on urban
	- For some years in MLT we don't have accurate information on age
	- For all years in MLT we don't have information on lstatus, empstat, school, electricity, primarycomp, computer, and cellphone
	- For some years in DJI, IRN, and MLT we don't have information on contract, internet, healthins, socialsec, tv, radio, washmach, sewmach, mcycle, fridge, car, and ownland
	- For some years in IRN we don't have information on imp_wat_rec, and imp_san_rec
*/
...
* directory macros
global raw_data "${ssgd_v2_userpath}\SSGD v2.0\raw_data\gmd\mena"
