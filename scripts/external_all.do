...
global rvars "ex_forestarea ex_energyint ex_co2emissions ex_coolingdays ex_heatingdays ex_waterstress ex_researchexp ex_legalrights ex_scientificart ex_patentapp ex_indinternet ex_polstab ex_regulqua ex_econsocrights ex_schoolgpi ex_ratiofem ex_netmigration ex_unmetcontr ex_voiceest"
...
foreach x in ex_treeloss ex_forestarea ex_energyint ex_co2emissions ex_coolingdays ex_heatingdays ex_waterstress ex_researchexp ex_legalrights ex_scientificart ex_patentapp ex_indinternet ex_polstab ex_regulqua ex_econsocrights ex_schoolgpi ex_ratiofem ex_netmigration ex_unmetcontr ex_voiceest{
	egen per_`x'_w1 = max(year) if `x'!=. & year>=2015 & year<=2018
