...
Issues:
	...
	- No data on trust in the government for Libya [variable]
	- No data on trust in the police [variable]
	- No data on freedom to join an organization [variable]
	- No data on confidence in government for Libya [variable]
*/
...
use "Arab_Barometer_Wave_6_Part_1_ENG_RELEASE.dta", clear
...
7 = Other
*/
* treatment is different for Lebanon due to raw data issues
recode Q1012A (5/6=95) (11=95) // muslim
recode Q1012A (1/4=96) // christian
recode Q1012A (10=97) // other
recode Q1012A (99=.)
recode Q1012A (95=5) (96=6) (97=7)
rename Q1012A temp1 // temporal variable for religion in Lebanon
* rest of countries
...
rename Q1012 temp2 // temporal variable for religion elsewhere
egen religion = rowtotal(temp1 temp2), m
label define religion 1 "No religion" 2 "Buddhist" 3 "Hindu" 4 "Jewish" 5 "Muslim" 6 "Christian" 7 "Other"
label values religion religion

* s5: region
recode Q1 (99998/99999=.)
rename Q1 region

* s6: domain/urban [NO DATA]
gen urban = -1
...
*/
gen internet_use = (Q409>=1 & Q409<=5) // every alternative except "I do not use the Internet"
...
/*
	...
	4	Strongly disagree
*/
gen men_better = (Q601_3==1 | Q601_3==2) // strongly agree or just agree
...
* data source
gen source = "Arab barometer 6 - Part 1"
...
save "$proc_data\arabbarometer6_part1.dta", replace
