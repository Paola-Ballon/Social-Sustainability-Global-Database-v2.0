...
local t_sex = "% of male population"
local t_ageg1 = "% of population aged 15-29 years"
local t_ageg2 = "% of population aged 30-59 years"
local t_ageg3 = "% of population aged 60+ years"
local t_youth = "% of ppl with 15-24 years"
local t_urban = "% of urban population"
...
local t_si_sel = "% of people who work and are self-employed"
local t_si_con = "% of people that works with a contract"
local t_si_wat = "% of households that have access to water"
...
local t_si_san = "% of households that have access to improved sanitation"
...
local t_si_ele = "% of households that have electricity"
local t_si_eleb = "access to electricity (% of population)"
local t_si_int = "% of households that have internet"
local t_si_prienr = "% of population attending primary school"
local t_si_pricom = "% of population with completed primary education"
...
local t_si_secenr = "% of population attending secondary school"
local t_si_secenrb = "school enrollment, secondary (% net)"
local t_si_hea = "% of population with health insurance"
local t_si_socsec = "% of population that has social security"
local t_si_femsec = "% of 25+ year-old women with at least secondary education"
local t_re_com = "% of households that have a computer"
local t_re_cel = "% of households that have a cellphone"
local t_re_tel = "% of households that have a TV"
local t_re_rad = "% of households that have a radio"
local t_re_was = "% of households that have a washing machine"
local t_re_sew = "% of households that have a sewing machine"
local t_re_mot = "% of households that have a motorcycle"
local t_re_fri = "% of households that have a fridge"
local t_re_car = "% of households that have a car"
local t_re_ownlan = "% of households that own land"
local t_re_assets = "Average share of assets"
local t_re_mortha = "% of households that have more than one person working for pay"
local t_re_rem = "% of population that receives remittances"
local t_sc_frespe = "% of population who can freely express what they think"
local t_sc_vot = "% of population who voted"
local t_sc_attdem = "% of population who attended a demonstration"
local t_si_intuse = "% of population who use the internet"
local t_re_enofoo = "% of population who have gone without enough food"
...
local t_sc_volass = "% of population who participate in a voluntary association"
local t_sc_conpol = "% of population with confidence in the police"
local t_sc_conjus = "% of population with confidence in the justice system"
local t_sc_conele = "% of population with confidence in elections"
local t_sc_congov = "% of population with confidence in government"
local t_sc_frejoi = "% of population that agrees they are free to join any organization they like without fear"
local t_sc_trupeo = "% of population who think most people can be trusted"
local t_sc_homnei = "% of population who do not like homosexuals as neighbors"
local t_sc_insnei = "% of population who feels insecure living in their neighborhood"
local t_sc_unshom = "% of population who feel unsafe from crime at home"
local t_si_menbet = "% of population who think men are better political leaders than women"
local t_re_savmon = "% of population that saves money"
local t_re_savmonb = "saved any money (% age 15+)"
local t_sc_actmem = "% of population who are active members in an organization"
local t_sc_solpro = "% of population who got together to try to solve problems"
local t_si_chiear = "% of women who are the chief earner in their household"
local t_re_govtra = "% of population who receive government transfers"
local t_re_govtrab = "received government transfer or pension (% age 15+)"
local t_sc_viccri = "% of population who were victims of crime"
local t_sc_racbeh = "% of population who say that racist behavior is frequent in their neighborhood"
local t_si_prowom = "% of population who think it is a problem if women earn more than men"
local t_si_menjob = "% of population who think men have more right to job than women"
local t_si_infint = "% of ppl that uses the internet as a source of information"
local t_si_ownban = "% of population who own a bank account"
local t_sc_fata = "fatalities due to violence"
local t_sc_numeve = "number of fatalities due to violence"
local t_re_totaff = "% of ppl affected by climate change index (0-100, low to high)"
local t_pl_riggua = "life and security guarantee index (0-100, low to high)"
local t_pl_powlim = "government powers limited by the judiciary index (0-100, low to high)"
local t_pl_nodis = "equal treatment and no discrimination index (0-100, low to high)"
local t_pl_govreg = "government regulations without improper influence index (0-100, low to high)"
local t_pl_accjus = "access to civil justice index (0-100, low to high)"
...
local t_pl_civspa = "civic space index (0-100, low to high)"
local t_ex_disability1 = "% of population who experienced discrimination based on disability"
local t_ex_disability2 = "% of population who have at least one household member living with disabilities"
...
* labels for controls
local t_ex_ferrat = "fertility rate (births per woman)"
...
local t_ex_humcap = "human capital index"
...
local t_ex_urbpop = "% of urban population"
local t_ex_shapro = "shared prosperity"
local t_ex_loggdp = "log of GDP per capita, PPP (constant 2017 international $)"
local t_ex_gaphci = "inequality of opportunities (by using the human capital index)"
local t_ex_shapp = "shared prosperity premium"
local t_ex_avega2 = "inequality of opportunities index"
local t_ex_hdi = "human development index"
local t_ex_wbl_index = "women, business and the law: overall score"
local t_ex_mobility = "women, business and the law: mobility score"
local t_ex_workplace = "women, business and the law: workplace score"
local t_ex_pay = "women, business and the law: pay score"
local t_ex_marriage = "women, business and the law: marriage score"
local t_ex_parenthood = "women, business and the law: parenthood score"
local t_ex_entrepreneurship = "women, business and the law: entrepreneurship score"
local t_ex_assets = "women, business and the law: assets score"
local t_ex_pension = "women, business and the law: pension score"
...
local t_ex_demind_polcul = "democracy index: political culture score"
local t_ex_demind_civil = "democracy index: civil liberties score"
...
local t_ex_waterstress = "level of water stress"
local t_ex_legalrights = "strength of legal rights index"
local t_ex_econsocrights = "economic and social rights performance score"
local t_ex_voiceest = "voice and accountability index (0-100, low to high)"
...
local t_ex_polstab = "political stability and absence of violence/terrorism index (0-100, low to high)"
local t_ex_regulqua = "regulatory quality index (0-100, low to high)"
...
preserve
rename ex_* di_*
rename sou_ex_* sou_di_*
rename per_ex_* per_di_*
...
replace x2 = "Development Indicators" if x2=="ex_"
...
* Additional changes
foreach x in variable short{
	gen t1 = substr(`x', 4, .)
	gen t2 = "di_"
	egen t3 = concat(t2 t1) if dimension=="Development Indicators"
	replace `x' = t3 if dimension=="Development Indicators"
	drop t1 t2 t3
}

label var countrycode "Country ISO-3 Code"
label var adm0_code "ADM0 Code (World Bank Classification)"
label var region "WBG Region"
label var incomegroup "WBG Income Group"
label var fragile "WBG Fragile and Conflict-Affected Situations (FCS)"
label var variable "Dimension + Indicator + Category"
label var dimension "Dimension"
label var category "Category (e.g. national, male, urban, etc.)"
label var adm1_code "ADM1 Code (World Bank Classification), Missing = -99"
label var short "Dimension + Indicator"
label var indicator "Indicator label"
label var indicator_type "Indicator type (e.g. index, percentage, magnitude, etc.)"
label var value "Value"
label var period "Year(s)"
label var source "Data source"
label var wave "Wave (either 1 or 2)"
label var area "Condensate of category"
label var scale "Indicator scale (e.g. numeric, percentage, count, etc.)"
label var range "Indicator range"
label var definition "Extended indicator label"
label var rel_cesa "Indicator is relevant for Citizen Engagement and Social Accountability"
label var rel_scorecld "Indicator is relevant for Social Cohesion, Resilience, and Community and Local Development"
label var rel_inclusion "Indicator is relevant for Inclusion"

order countryname countrycode region incomegroup fragile adm0_code adm1_code dimension short category area variable indicator definition indicator_type wave period scale range source value rel_*
